  ...
  return (
    <div className=" flex justify-center items-center my-20">
      <div className="grid grid-cols-2 w-[60%]">
        <p className="my-4 text-5xl tracking-wider col-start-2 row-start-1 self-end max-md:ms-7 max-md:row-start-1 max-md:col-span-3 max-md:text-center max-md:text-4xl">
        ...
        <img
          ...
          alt=""
        />
        <p className="col-start-2 row-start-2 self-start my-4 max-md:row-start-3 max-md:col-span-3 max-md:text-center">
